      ...
      <div className="relative border-b border-indigo-500/10 bg-gradient-to-br from-indigo-950/40 via-background to-blue-950/30 backdrop-blur-xl py-12 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="space-y-4">
            ...
            <div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-indigo-400 via-blue-400 to-indigo-300 bg-clip-text text-transparent tracking-tight drop-shadow-[0_0_30px_rgba(129,140,248,0.3)]">
