      ...
      >
        ...
        <div className="space-y-6">
          ...
          <ol className="space-y-4">
            <li className="flex gap-3">
              ...
              <div className="text-white/90">
                <p className="font-medium">Contacta al soporte de Exness</p>
                <p className="text-sm text-white/70 mt-1">
                  Escribe al soporte y solicita <strong>cambio de partner</strong>
                </p>
              </div>
            </li>
            ...
            <li className="flex gap-3">
              ...
              <div className="text-white/90 flex-1">
                <p className="font-medium">Indica este Partner ID:</p>
                ...
                <p className="text-xs text-white/60 mt-1">(Tálamo)</p>
              </div>
            </li>
            ...
            <li className="flex gap-3">
              ...
              <div className="text-white/90">
                <p className="font-medium">Valida tu acceso</p>
                <p className="text-sm text-white/70 mt-1">
                  Cuando te confirmen, regresa y presiona <em>Validar afiliación</em>
                </p>
              </div>
            </li>
          </ol>
          ...
          <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
            <p className="text-cyan-300 text-sm font-medium">Alternativa:</p>
