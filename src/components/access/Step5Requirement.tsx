...
interface Step5RequirementProps {
  onNext: () => void;
  onValidateNow: () => void;
}

const Step5Requirement = ({ onNext, onValidateNow }: Step5RequirementProps) => {
    ...
    <div className="space-y-8">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Para acceder a Tálamo necesitas operar con Exness bajo nuestra afiliación. 
          Esto garantiza condiciones reales, seguridad y transparencia.
        </p>
      </div>
...
export default Step5Requirement;