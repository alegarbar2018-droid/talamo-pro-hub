...
export const CapitalStep = ({
  ...
  const capitalOptions: { value: CapitalBand; label: string; description: string }[] = [
    { value: "<500", label: "Menos de $500", description: "Ideal para empezar con micro-lotes" },
    { value: "500-2000", label: "$500 - $2,000", description: "Buen balance para operar" },
    { value: "2000-10000", label: "$2,000 - $10,000", description: "Capital intermedio sólido" },
    { value: ">10000", label: "Más de $10,000", description: "Acceso a cuentas premium" }
  ];
          ...
          >
            ...
            <div className="relative space-y-3">
              <h3 className={`text-2xl sm:text-3xl font-bold transition-colors duration-300 ${
                capital === option.value ? "text-primary" : "text-foreground group-hover:text-primary"
              }`}>
                {option.label}
              </h3>
